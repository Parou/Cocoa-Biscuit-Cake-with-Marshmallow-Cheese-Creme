...
all: link
    # eat the cake
    mv clean_surface/cake.tin /dev/null
    clear
...
ground:
    ...
    cd clean_surface
    rm -f cake.tin && touch cake.tin
    echo "Biscuit $(BISC_MASS)g" >> cake.tin
    echo "Cocoa powder $(COCOA_MASS)g" >> cake.tin
    echo "Butter $(BUTTER_MASS)g" >> cake.tin
    cd ..
